...
<header class="d-flex justify-content-between align-items-center py-4 px-5">
    ...
    <div class="container">
        <h1>Bonifico</h1>
        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmModal">Effettua Bonifico</button>
    </div>
    <div class="container">
    <h1>Bonifico</h1>
    <form>
        ...
        <button type="submit" class="btn btn-danger">Effettua Bonifico</button>
    </form>
</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="color: #000;">
                    <h5 class="modal-title" id="confirmModalLabel">Conferma Bonifico</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <p style="color: #000;">Sei sicuro di voler procedere con l'effettuazione del bonifico?</p>
                </div>
